        ...
        <GuestLayout>
            ...
            <div className="text-center py-10 text-gray-900 dark:text-white">
                ...
                <div className="mt-6">
                    <Link
                        href="/"
                        className="inline-flex items-center rounded-md border border-gray-300 bg-gray-800 dark:bg-gray-900 px-4 py-2 text-xs font-semibold uppercase tracking-widest text-white transition duration-150 ease-in-out hover:bg-gray-700 dark:hover:bg-gray-700 focus:bg-gray-700 dark:focus:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                    >
                        Show your website
                    </Link>
                </div>
